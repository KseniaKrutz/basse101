...
[![shipthatcode — Python Fundamentals](https://api.shipthatcode.com/cert/29962e0166ed0270c2da98c6591e8313.svg)](https://shipthatcode.com/courses/python-fundamentals)

My working repo for [Python Fundamentals](https://shipthatcode.com/courses/python-fundamentals) on [shipthatcode.com](https://shipthatcode.com) — built lesson by lesson in my own editor.
...
3. In your terminal, inside the unzipped folder, push it to GitHub:
   ...
   git init
   git add .
   git commit -m "start Python Fundamentals"
   git branch -M main
   git remote add origin https://github.com/YOUR-USERNAME/YOUR-REPO.git
   git push -u origin main
   ```

4. Paste your repo link on the [course page](https://shipthatcode.com/courses/python-fundamentals) ("Work in your own editor" → **Link repo**). Done — you never do this again.
...
- `main.py` — the program. It grows as the course progresses; each lesson adds to it.
...
Courses improve over time — exercises get added, tests get fixed. If the [course page](https://shipthatcode.com/courses/python-fundamentals) says your starter is out of date: download a fresh zip, **delete this repo's `tests/` folder entirely**, copy in the fresh `tests/` and `.shipthatcode.json`, and keep your own code exactly as it is. (Don't merge test folders — lesson numbering can shift between versions.) Lessons you've already completed stay completed either way.
